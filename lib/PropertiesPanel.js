...
function PropertiesPanel(sideTabsProvider, eventBus, modelling, propertiesProvider, diagramSettings) {
...
PropertiesPanel.prototype._handleChange = function(event){
  ...
  var entryId = $(event.delegateTarget).attr('name'),
      newVal = $(event.delegateTarget).val(),
